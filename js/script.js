...
class miNav2 extends HTMLElement {
  connectedCallback() {
    ...
    <div class="container">
          ...
          <div class="col-12 col-md-6 mb-3">
            ...
            <ul class="nav flex-column">
              <li class="nav-item mb-2">
                <a href="docs/Contrato Fotográfico de AM FOTOGRAFÍA.pdf" target="_blank" class="nav-link p-0 text-body-secondary">Reglamento</a>
                
              </li>
              <li class="nav-item mb-2">
                <a href="lugares.html" class="nav-link p-0 text-body-secondary"
                  >Lugares recomendados</a
                >
              </li>
        ...
        >
          <p>
            &copy; <span id="currentYear"> </span> Brain Soft, Inc. All rights
            reserved.
          </p>
          <ul class="list-unstyled d-flex">
            ...
            <li class="ms-3">
              <a class="link-body-emphasis" href="https://www.facebook.com/AMFOTOCR" target="_blank"
                ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                </svg></a>
            </li>
            <li class="ms-3">
              <a class="link-body-emphasis" href="https://api.whatsapp.com/send?phone=84449279"
